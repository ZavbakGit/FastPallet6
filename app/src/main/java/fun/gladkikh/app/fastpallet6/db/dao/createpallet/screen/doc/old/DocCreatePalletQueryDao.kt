package `fun`.gladkikh.app.fastpallet6.db.dao.createpallet.screen.doc.old
...
interface DocCreatePalletQueryDao {
    ...
    fun getSimpleListProductCreatePalletLiveData(guidDoc: String): LiveData<List<ProductCreatePalletDb>>
    ...
    fun getListProductCreatePallet(guidDoc: String): List<ProductItemCreatePalletQueryDb>

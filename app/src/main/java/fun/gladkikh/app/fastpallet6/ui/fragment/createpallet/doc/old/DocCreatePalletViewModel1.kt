...
class DocCreatePalletViewModel1(private val docCreatePalletRepository: DocCreatePalletRepository) :
    BaseViewModel() {
    ...
    private val entityObserver = Observer<CreatePallet> {
        entityViewStateLiveData.value =
            DocEntityCreatePalletViewState(
                entity = it
            )
    }
